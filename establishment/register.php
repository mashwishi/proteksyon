...
<html lang="en">
  <head>
    ...
    <!-- Site Title  -->
    <title>Proteksyon | Establishment Register</title>
  ...
  <div id="login">
    ...
    <h1>Create Establishment Account</h1>
      <fieldset>
          ...
          <div class="tab">
              Establishment Name:
              <p><input placeholder="Enter Name" oninput="this.className = ''" name="ename" type="text"></p>
          ...
          <!-- 3 Country, city, zipcode, address -->
          <div class="tab">
              Country:
              <p>            
          ...
          <div class="tab">
              Time Open:
              <p>
                <input type="time" id="time_open" name="time_open"  required oninput="this.className = ''">
              </p>
              Time Closed:
              <p>
              <input type="time" id="time_close" name="time_close" required oninput="this.className = ''">
              </p>            
          </div>   
          <!-- 6 documents -->       
          <div class="tab">       
              <div class="file-upload">
                Document:  
                <button class="file-upload-btn" type="button" onclick="$('.frontfile-upload-input').trigger( 'click' )">Select File</button>
                <p style="font-size: 10px;">Upload business permit or any proof of business documents.
                <br/>Supported Format: PNG, JPG, JPEG, PDF, DOC, DOCX
                <br/>Max Upload Size: 10.00MB
                </p>  
                <div class="frontimage-upload-wrap">
                        <input id='front_card' class="frontfile-upload-input" type='file' name="business_document" onchange="frontreadURL(this);"  accept=".png, .jpg, .jpeg, .pdf, .doc, .docx" />
          ...
          <div class="tab">
            <div class="file-upload">
                ...
                <br/>Supported Format: PNG, JPG, JPEG
                <br/>Max Upload Size: 10.00MB
                </p>   
    ...
    <p>Have an account? <a href="/establishment/login">Login Account</a>.</p> 
    </div> 
