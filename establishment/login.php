...
<html lang="en">
  <head>
    ...
    <!-- Site Title  -->
    <title>Proteksyon | Establishment Login</title>
  ...
  <div id="login">
    ...
    <form action="authEstablishment.php" method="post">
    <h1>Establishment Account</h1>
      <fieldset>
        ...
        <p>
            <input
                ...
                required 
                autocomplete="off"
                name="establishment_password" 
                placeholder="Password"
            >
            <!--<p><a href="/password-reset">Forgot Password?</a></p>-->
        </p>
        <center><p><a href="/establishment/forgot_password">Forgot Password Account</a></p></center>
        ...
        <p><strong><a href="/establishment/register">Don't have account? Create Account</a>.</strong></p>
