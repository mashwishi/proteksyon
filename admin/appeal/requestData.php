...
<head>
	...
	<style>
		...
		background-image: url("assets/img/opacity-sabang.png");
		}
	</style>
</head>
<body>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="/admin/appeal">Appeal</a>
						</li>
					</ul>
				</div>
			</div>
                    ...
                    <div class="container" style="margin-bottom: 25px;">
                        <div class="row">
							<script>
									...
									var element = document.getElementById('sectionPrint');
									$("#sectionPrint").toggleClass("watermarked");
										if(element.classList.contains('watermarked')){
												document.getElementById("downloadButton").innerHTML = "<i class='fas fa-arrow-down'></i> Currently downloading, please wait";
												...
												document.getElementById("downloadButton").innerHTML = "<i class='fas fa-file'></i>&nbsp;Download as PDF";
												setTimeout(function() {
													$("#sectionPrint").removeClass("watermarked");
												}, 5000);
										}
									}
							</script>
