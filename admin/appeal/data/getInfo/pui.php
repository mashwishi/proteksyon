<?php
        ...
        if ($row['status'] == 1)
        {
            ...
            if($row['report_status'] == 3){
                ...
                <strong>Notice:</strong> This person is fine, Preview of the previous data only.
            ...
            if($row['report_status'] == 1){
                ...
                <div class="form-group" style="margin-bottom: 10px;">
                    ...
                    <div id="buttonsOption">
                        <input type="submit" name="applyFine" class="btn btn-success" value="Not Positive">
                        <input type="submit" name="applyPositive" class="btn btn-warning" value="Positive to Covid">
                ...
                <div class="form-group" style="margin-bottom: 10px;">
                    ...
                    <div id="buttonsOption">
                        <input type="submit" name="startQuarantine" class="btn btn-warning" value="Start Quarantine">
                        <input type="submit" name="deleteAppeal" class="btn btn-dark" value="Decline">
                    </div>
                    <script type="text/javascript">
                        $("#buttonsOption").hide();
