...
<head>
	...
	<title>Proteksyon | Verifying User</title>
    ...
    <script type="text/javascript">       
        $(document).ready(function(){ 
            ...
            function checkUpdate()
            {
				...
				else if(msgUpdateInfo == 10){
                    //Error not checked
                    $("#alertInformation").html('<div class="alert alert-warning alert-dismissible fade show" role="alert"><strong>Warning!</strong> Failed to send email, However the action has been executed successfully<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
                }
                else{
                    //none
                }
