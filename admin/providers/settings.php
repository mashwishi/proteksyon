			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="/admin/providers">Providers</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="order">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <input type="text" style="visibility:hidden;" class="form-control" id="xx_provider_id" name="xx_provider_id" required>
                                <h4>Password</h4>
                                <div class="col">
