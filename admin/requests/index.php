...
<head>
	...
	<title>Proteksyon | Requests</title>
                            ...
                            <div class="row">
                                <div class="col-sm">
									<div class="input-group">
										<input type="text" name="search_box" id="search_box" class="form-control" placeholder="Search Request ID..." style="width: 75% !important;"/>
									</div>
                                </div>
                            </div>
                        </form>
