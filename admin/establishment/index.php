...
<head>
	...
	<title>Proteksyon | Establishment List</title>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="/establishment">Establishment</a>
						</li>
					</ul>
				</div>
			</div>
                            ...
                            <div class="row">
                                <div class="col-sm">
									<div class="input-group">
										<input type="text" name="search_box" id="search_box" class="form-control" placeholder="Search Establishment Name..." style="width: 75% !important;"/>
									</div>
                                </div>
                            </div>
                        </form>
